...
test_pipeline = [
    ...
    dict(type="Voxelization", cfg=voxel_generator, distillation= False),
    dict(type="AssignLabel", cfg=train_cfg["assigner"]),
    dict(type="Reformat"),
]

train_anno = "../data/waymo/infos_train_01sweeps_filter_zero_gt.pkl"
val_anno = "../data/waymo/infos_val_01sweeps_filter_zero_gt_pcd.pkl"
test_anno = None
...
load_from = './work_dirs/waymo_centerpoint_voxelnet_1x/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
distillation = True
