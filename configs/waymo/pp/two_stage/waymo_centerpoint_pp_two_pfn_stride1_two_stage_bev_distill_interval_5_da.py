...
S_model = dict(
    ...
    first_stage_cfg=dict(
        ...
        pretrained='work_dirs/waymo_centerpoint_pp_two_pfn_stride1_3x_distill_interval_5/epoch_30.pth',
        reader=dict(
...
val_anno = "../data/waymo/domain_adaptation/infos_val_01sweeps_filter_zero_gt.pkl"
test_anno = None
