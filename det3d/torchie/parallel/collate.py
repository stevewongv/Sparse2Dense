...
def collate_kitti(batch_list, samples_per_gpu=1):
    ...
    for key, elems in example_merged.items():
        if key in ["voxels", "num_points", "num_gt", "voxel_labels", "num_voxels",
                   "cyv_voxels", "cyv_num_points", "cyv_num_voxels", "dense_voxels","dense_num_points","dense_num_voxels","reconstruction_voxels","reconstruction_num_points","reconstruction_num_voxels","reconstruction_voxels_4","reconstruction_num_points_4","reconstruction_num_voxels_4","reconstruction_voxels_2","reconstruction_num_points_2","reconstruction_num_voxels_2"]:
        ...
        elif key in ["coordinates", "points", "cyv_coordinates", "dense_points","dense_coordinates",'reconstruction_coordinates','reconstruction_points','reconstruction_coordinates_4','reconstruction_coordinates_2']:
            coors = []
